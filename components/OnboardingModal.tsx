  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        tabIndex={-1}
        className="bg-dark-700 rounded-2xl shadow-dark-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto focus:outline-none border border-dark-600"
      >
        ...
        {stage === 'disclaimer' && (
          <>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-dark-600 border border-dark-500 rounded-xl p-5">
                ...
                <div className="text-slate-300 space-y-2 text-sm leading-relaxed">
                  <p>
                    <strong className="text-white">ClaimCraft UK is a document preparation service.</strong> We are NOT a law firm,
              ...
              <div className="space-y-2">
                <h3 className="font-bold text-white text-sm">By using this service, you acknowledge:</h3>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 rounded-xl p-4">
                <h3 className="font-bold text-white mb-2 text-sm">Need Free Legal Advice?</h3>
                <div className="text-slate-300 space-y-1 text-xs">
                  <div className="flex gap-2">
                    <span className="text-violet-400">•</span>
                    <span><strong className="text-white">Citizens Advice:</strong> www.citizensadvice.org.uk</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-violet-400">•</span>
                    <span><strong className="text-white">Find a Solicitor:</strong> www.lawsociety.org.uk</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Footer Actions */}
            <div className="bg-dark-800 border-t border-dark-600 p-6 flex gap-4">
              <button
                onClick={onDecline}
                className="flex-1 px-6 py-3 border border-dark-500 bg-dark-600 text-slate-300 rounded-xl font-medium hover:bg-dark-500 transition-colors duration-200 flex items-center justify-center gap-2"
              >
                <X className="w-4 h-4" />
                I Do Not Accept
              </button>
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-violet-600 to-violet-500 text-white rounded-xl font-bold hover:from-violet-500 hover:to-violet-400 transition-all duration-200 hover:-translate-y-0.5 flex items-center justify-center gap-2 shadow-glow focus:outline-none focus:ring-2 focus:ring-violet-500/50"
              >
                I Understand & Accept
          ...
          <>
            <div className="bg-dark-600 p-6 border-b border-dark-500">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl flex items-center justify-center shadow-glow">
                  <ShieldAlert className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h2 className="text-xl font-bold text-white">Eligibility Check</h2>
                  <p className="text-sm text-slate-400">Quick questions to ensure your claim is viable</p>
                </div>
              </div>
            </div>
              ...
              {disqualifiedReason ? (
                <div className="text-center animate-fade-in">
                  <div className="bg-red-500/10 p-4 rounded-xl border border-red-500/30 mb-6">
                    ...
                    <p className="font-bold text-red-300 mb-1">Not Recommended</p>
                    <p className="text-red-400 text-sm leading-relaxed">{disqualifiedReason}</p>
                  </div>
                  <button
                    onClick={onDecline}
                    className="w-full py-3 bg-dark-600 hover:bg-dark-500 text-white font-bold rounded-xl transition-colors duration-200 border border-dark-500"
                  >
                    Close
                  </button>
                </div>
                ...
                <div className="animate-fade-in">
                  <div className="mb-4 flex justify-between items-center text-xs font-bold text-slate-500 uppercase tracking-widest">
                  ...
                  <h3 className="text-xl font-bold text-white mb-3">{currentQuestion.question}</h3>
                  <p className="text-slate-400 mb-8 text-sm">{currentQuestion.details}</p>

                  <div className="grid grid-cols-2 gap-4">
                    <button
                      onClick={currentQuestion.no}
                      className="py-4 rounded-xl border border-dark-500 bg-dark-600 font-bold text-slate-300 hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200"
                    >
                      No
                    </button>
                    <button
                      onClick={currentQuestion.yes}
                      className="py-4 rounded-xl bg-gradient-to-r from-violet-600 to-violet-500 text-white font-bold shadow-glow hover:from-violet-500 hover:to-violet-400 transition-all duration-200"
                    >
                      Yes
                    </button>
                  </div>
