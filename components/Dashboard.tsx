...
import { ClaimState, DocumentType, AccountingConnection, Deadline, DeadlinePriority, DeadlineStatus } from '../types';
import { Plus, FileText, CheckCircle2, Trash2, Upload, Briefcase, Calendar, ChevronRight, Zap, Link as LinkIcon, Download, XCircle, Search, Filter, PoundSterling, CircleCheck, AlertTriangle, Clock } from 'lucide-react';
                 ...
                 {upcoming.map(deadline => {
                   ...
                   return (
                     ...
                     >
                       ...
                       <h3 className="font-semibold text-slate-900 mb-1 truncate" title={deadline.title}>
                         {deadline.title}
                       </h3>
